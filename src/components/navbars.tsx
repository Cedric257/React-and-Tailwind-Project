...
export default function NavBars() {
  ...
  const linkBaseClasses = "text-[17px] font-normal transition-colors";
  const getLinkClass = ({ isActive }: { isActive: boolean }) =>
    isActive
      ? `${linkBaseClasses} text-[#6EC1F6] dark:text-[#28A8EA]`
      : `${linkBaseClasses} text-white dark:text-[#dce8fa] hover:text-[#6EC1F6] dark:hover:text-[#28A8EA]`;
  return (
    <>
        <header className="w-full">
      <div className="bg-white dark:bg-[#1a2150] h-[42px] sm:h-[64px] border-b border-gray-100 dark:border-[#22295a] flex items-center">
    ...
    {/* <header className="w-full">
      <div className="bg-white dark:bg-[#1a2150] w-full h-[42px] sm:h-[64px] flex items-center border-b border-gray-100 dark:border-[#22295a]">
        <div className="max-w-[1380px] w-full mx-auto flex items-center justify-between px-2 sm:px-8">

          <div className="flex-shrink-0 select-none font-serif text-[1.25rem] sm:text-[2rem] leading-none">
            <img src="src/assets/favicon.png" className="h-[2.5rem] sm:h-[4rem] w-auto" alt="" />
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-[10px] sm:text-xs font-semibold text-[#23295A] dark:text-white">EMERGENCY</span>
              <span className="text-[10px] sm:text-xs text-[#28A8EA] dark:text-[#66cfff] font-medium">(+257) 61377295</span>
            </div>
          </div>
